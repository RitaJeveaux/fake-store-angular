...
- **Página de Detalhes:** Mostra informações detalhadas de um produto selecionado.
- **Carrinho de Compras:**
...
- **[Bootstrap](https://getbootstrap.com/):** Framework de CSS para estilização dos componentes.
- **[Fake Store API](https://fakestoreapi.com/):** API pública utilizada para obter os dados dos produtos.
...
1. **Clone o repositório:**
   ```bash
   git clone https://github.com/seu-usuario/fake-store-angular.git
   ```
...
<h4 align="center"><i>Projeto desenvolvido com ❤️ para fins de estudo.</i></h4>
